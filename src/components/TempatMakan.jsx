        ...
        <div className="container">
            <div className="row">
                <div className="col-12 text-center">
                    <h1 className="content-2-head fw-semibold">Tempat Makan</h1>
                </div>
            </div>
        </div>
        <div id='bgKulinerCianjur' className='mt-3' data-aos="fade-right">
            <div className="container">
                <div className="row flex-wrap justify-content-start pt-5">
                    {
                        kuliner.filter((item, index) => item.kategori_kuliner == 'Tempat Makan' && index < 8).map((item, index) => (
