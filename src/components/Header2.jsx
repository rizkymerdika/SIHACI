...
function Header2({header, link1, link2, link3, submenu1, submenu2, submenu3, style}) {
  return (
                ...
                <div className="col-12">
                    <div className="dropdown">
                        ...
                        <ul className="dropdown-menu" id="dropdown-menu">
                            ...
                            <li style={{display: style}}><Link to={link3} className="dropdown-item">{submenu3}</Link></li>
                        </ul>
                    </div>
                </div>
            </div>
