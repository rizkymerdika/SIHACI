...
function WisataSejarah() {
  ...
  return (
    <div className="mt-5" data-aos='fade-up'>
        <h1 className="content-2-head fw-semibold text-center">Wisata Sejarah</h1>
            ...
            <div className="container pt-3">
                <div className="row mt-3">
                    <div className="col-12">
                        <Slider {...settings}>
                            {
                                objekWisata.filter((item, index) => item.kategori_wisata == 'Wisata Sejarah' && index < 12).map((item, index) => (
                                    <div key={index}>
                                        <Link to={`/objekwisata/wisatasejarah/detailwisata/${item.id_wisata}`}>
                ...
                <div className="row mt-4">
                    <div className="col-12 text-end">
                        <Link to={"/objekwisata/wisatasejarah"}>
