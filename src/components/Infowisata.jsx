...
function Infowisata() {
  ...
  return (
    <>
        <div className="container infowisata mt-5" data-aos='fade-up'>
            <div className="row">
                <div className="col text-center">
                    <h1 className="content-2-head fw-semibold">Informasi Tempat Wisata</h1>
                </div>
            </div>
            <div className="row align-items-center mt-4" data-aos='fade-right'>
                ...
                <div className="col-12 col-lg-6 my-3 my-lg-0">
                    ...
                    <p className='my-0 mt-1 content-2-text'>Cianjur, di Provinsi Jawa Barat, menawarkan keindahan wisata alam yang memukau. Dari air terjun yang gemercik mempesona, hingga danau-danau yang tenang dan dikelilingi oleh panorama pegunungan yang menakjubkan, setiap sudut Cianjur memancarkan pesona alam yang luar biasa. Hutan yang lebat, perkebunan teh yang hijau, serta pemandangan gunung yang menjulang memberikan pengalaman alam yang menakjubkan bagi para pengunjung.</p>
                </div>
            </div>
            <div className="row align-items-center flex-row-reverse mt-1" data-aos='fade-left'>
                <div className="col-12 col-lg-6 d-block text-center">
